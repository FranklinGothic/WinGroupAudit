...
class group_scanner:
    ...
    @staticmethod
    def _process_single_group(audit_type, parent_group, top_level_group, visited=None):
        """
        ...
        if children_output:
            ...
            for child in children_list:
                ...
                if child:
                    ...
                    child_groups[child].append(group_scanner._get_group_permmisions(audit_type, child))
        if top_level_group:
    ...
    @staticmethod
    def get_nested_groups(audit_type, parent_groups, max_workers=3): #create more threads for thoretical greater speed but may cause degregration if too many
        """
        ...
        with ThreadPoolExecutor(max_workers=max_workers) as executor:
            futures_to_execute = [
                executor.submit(group_scanner._process_single_group, audit_type, parent, True) for parent in parent_groups
            ]
    ...
    @staticmethod
    def _get_group_permmisions(audit_type):
        match audit_type:
